...
- https://hypergen.it - Django Liveview
...
#+begin_src xml
<!-- API Request: JSON → XML → Tokenizer → H100 GPUs -->
<!-- ~307KB, 33,606 tokens, 80.9% cached, $0.137/request -->
...
<tool name="Read"><description>Read files, images, PDFs</description></tool>
...
<tool name="Glob"><description>Find files by pattern</description></tool>
<tool name="Task"><description>Launch specialized agents</description></tool>
<!-- ... 34 more tools ... -->
...
<tool name="mcp__email__compose_new_email">
  <description>Compose email from markdown</description>
</tool>
<!-- ... 12 more MCP tools ... -->
</tools>
</system>
...
I'm seeing this error in my browser. Can you fix the password hashing
vulnerability in src/auth/password.py that's causing it?
</message>
...
├── settings.json                  # Team-shared configuration (committed to git)
├── settings.local.json            # Personal overrides (gitignored)
├── .mcp.json                      # Model Context Protocol server configuration
├── commands/                      # Custom slash commands
│   ├── issue.md                  # Create issues, branches, PRs, worktrees
...
│   ├── api-design/
│   │   ├── SKILL.md              # API design patterns and conventions
│   │   └── examples.md
│   └── security-review/
│       └── SKILL.md
├── agents/                        # Custom subagents with separate context
│   ├── code-reviewer.md          # Review PRs and suggest improvements
│   ├── test-writer.md            # Generate comprehensive tests
│   └── docs-updater.md           # Keep documentation in sync
└── hooks/                         # Custom automation scripts
    ├── post-tool-use.sh          # Auto-format on file edits
    └── pre-commit.sh             # Lint and type-check before commits

llm/                               # Application-specific documentation
├── auth.md                        # Authentication & authorization
├── billing.md                     # Payment processing
├── api.md                         # API endpoints and schemas
└── features.md                    # Cross-cutting feature docs
...
Also add a RateWindowChart that displays the last 24 hours with sorting and pagination. Make it look good and 
follow the patterns used elsewhere in the project.
#+end_src
