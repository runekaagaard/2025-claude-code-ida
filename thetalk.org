...
** Me
- Rune Kaagaard
- Lead Developer at Prescriba (psychological counseling platform)
- Building AI-powered developer tools

** AI Projects
- MCP Alchemy: Database MCP server for Claude
- Connects Claude to PostgreSQL, MySQL, SQLite, and more
- AI-assisted SQL queries and schema exploration
